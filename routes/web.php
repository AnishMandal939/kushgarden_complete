...
Route::get('/', function () {
    ...
    return view('welcome',compact('about','products','banners'));
})->name('main');

Route::get('/about-us', [AboutUsController::class, 'show'])->name('about');
Route::get('/events', [GalleryController::class, 'show'])->name('events');
...
Route::post('/contact/create', function (ContactStoreRequest $request) {
    ...
    $contact->save();
    Mail::to('sendmailtestanish@gmail.com')->send(new MessageSent($contact));
